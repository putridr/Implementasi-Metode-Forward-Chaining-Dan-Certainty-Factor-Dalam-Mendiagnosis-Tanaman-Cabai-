                          ...
                          ?>
                            <tr style="text-align: justify;">
                              ...
                              <?php
                                ...
                                <?php } else { ?>
                                  <img src="../master_file/foto/<?php echo $row['gambar_saran']; ?>" style="width:100px;height:100px;">
                                <?php } ?>
                              </td>
                              <td>
                                <?php
                                  if ($row['gambar_penyakit'] == "") { ?>
                                    <img src="https://via.placeholder.com/500x500.png?text=No-Image" style="width:100px;height:100px;">
                                  <?php } else { ?>
                                    <img src="../master_file/foto/<?php echo $row['gambar_penyakit']; ?>" style="width:100px;height:100px;">
                                  <?php } ?>
                              </td>
                                  ...
                                  <div class="modal-dialog modal-dialog-centered">
                                    <div class="modal-content">
                                      ...
                                      <div class="modal-body" style="text-align: justify;">
                                        Apakah anda yakin ingin menghapus <?php echo $row['nama_penyakit'] ?> penyakit Hama ?
                                      </div>
